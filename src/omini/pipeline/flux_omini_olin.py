...
def encode_images(pipeline: FluxKontextPipeline, images: torch.Tensor):
    """
...
class Condition(object):
    ...
    def encode(
        self, pipe: FluxKontextPipeline, empty: bool = False
...
def generate(
    ...
    **params: dict,
    ...
    latents, _, latent_image_ids, _ = self.prepare_latents(
        None,
